...
txtDisplay = Entry(calc, font=('sans-serif',20,'bold'),
				bg='black',fg='white',
...
btnsq = Button(calc, text="\u221A",width=6, height=2,
			bg='powder blue', font=('sans-serif',
									20,'bold'),
...
btnPM = Button(calc, text=chr(177),width=6,
			height=2,bg='powder blue', font=('sans-serif',20,'bold'),
...
# ROW 1 :
btnPi = Button(calc, text="pi "+chr(960),width=6,
			height=2,bg='black',fg='white',
			font=('sans-serif',20,'bold'),
...
lblDisplay = Label(calc, text = "Scientific",
