...
# load rubik.png
rubik = pygame.image.load("rubik.png")
# make rubik to 30x30
rubik = pygame.transform.scale(rubik, (30, 30))
# use grass_image as background
...
pygame.display.set_caption('Snakeeeeees')
...
# Game Over
def game_over():
    # fill with wasted.png
    game_window.blit(wasted_image, (50, -120))
